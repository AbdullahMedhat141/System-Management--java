...
public class Files2Controller implements Initializable {
    @FXML
    ...
    public void onAttendance2() {
        navigation.navigateTo(rootPane, navigation.Attendance2_FXML);
    }
    ...
    public void add() {
        try {
            if (model.getStudentById(Integer.parseInt(studentId.getText())) == null) {
                ...
                model.addJavaStudent(new Student(model.getStudentById(Integer.parseInt(studentId.getText())).getName(),
    ...
    public void remove(ActionEvent event) throws IOException {
        ...
        model.deleteJavaStudentById(selected.getId());
        model.save_JavaStudents();
    }
    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableControl.setItems(FXCollections.observableArrayList(model.getJavaStudents()));

        name.setCellValueFactory(new PropertyValueFactory<>("name"));
        id.setCellValueFactory(new PropertyValueFactory<>("id"));
        address.setCellValueFactory(new PropertyValueFactory<>("address"));
        table.setItems(FXCollections.observableArrayList(model.getJavaStudents()));
    }
    ...
    public void save(MouseEvent event){
        ...
        if(file != null){
            saveStudents(file,  model.getJavaStudents());
        }
    }
